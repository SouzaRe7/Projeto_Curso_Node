...
export class FuncionarioService {
  static async selecionarTodosFuncionarioService(): Promise<
    Array<IFuncionario> | undefined
  > {
    try {
      const retSelecionarTodosFuncionario: Array<IFuncionario> =
  ...
  static async criarFuncionarioService(
    objectDTO: IFuncionario
  ): Promise<IFuncionario | null | undefined> {
    try {
      const validarEmail = await Funcionario.findOne({
  ...
  static async detalharFuncionarioService(
    id: string
  ): Promise<IFuncionario | null | undefined> {
    try {
  ...
  static async alterarFuncionarioService(
    id: string,
    objectDTO: IFuncionario
  ): Promise<IFuncionario | null | undefined> {
    try {
      ...
      const alteracaoFuncionario = await Funcionario.findOneAndUpdate(
        { _id: id },
        objectDTO
      );
  ...
  static async excluirFuncionarioService(
    id: string
  ): Promise<IFuncionario | null | undefined> {
    try {
      const idExcluirFuncionario: IFuncionario | null | undefined =
        await Funcionario.findOneAndDelete({ _id: id });
